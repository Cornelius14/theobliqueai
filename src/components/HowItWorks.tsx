        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <ol className="relative grid gap-10 before:absolute before:left-5 before:top-0 before:bottom-0 before:w-px before:bg-white/10 light-mode:before:bg-black/10">
            <li className="relative pl-14">
              <span className="absolute left-0 top-0 h-10 w-10 rounded-full bg-white/8 ring-1 ring-white/15 light-mode:bg-black/8 light-mode:ring-black/15 flex items-center justify-center text-slate-950">
              ...
              <h3 className="text-base font-medium text-slate-950">Tell Us What You're Looking For</h3>
            </li>
            <li className="relative pl-14">
              <span className="absolute left-0 top-0 h-10 w-10 rounded-full bg-white/8 ring-1 ring-white/15 light-mode:bg-black/8 light-mode:ring-black/15 flex items-center justify-center text-slate-950">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" className="h-5 w-5 text-slate-200 light-mode:text-slate-800 bg-slate-950">
              ...
              <h3 className="text-base font-medium text-slate-950">AI Sources Prospects</h3>
            </li>
            <li className="relative pl-14">
              <span className="absolute left-0 top-0 h-10 w-10 rounded-full bg-white/8 ring-1 ring-white/15 light-mode:bg-black/8 light-mode:ring-black/15 flex items-center justify-center text-slate-950">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" className="h-5 w-5 text-slate-200 light-mode:text-slate-800 bg-slate-950">
              ...
              <h3 className="text-base font-medium text-slate-950">Multi-Channel Outreach</h3>
            </li>
            <li className="relative pl-14">
              <span className="absolute left-0 top-0 h-10 w-10 rounded-full bg-white/8 ring-1 ring-white/15 light-mode:bg-black/8 light-mode:ring-black/15 flex items-center justify-center text-slate-950">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" className="h-5 w-5 text-slate-200 light-mode:text-slate-800 bg-slate-950">
              ...
              <h3 className="text-base font-medium text-slate-950">Qualified Meetings Booked</h3>
            </li>
          </ol>
